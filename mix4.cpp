...
std::vector<char*> prepare_args(const std::vector<std::string> &command);
 ...
 */
void execute_action(const std::string &action_name, int input_fd, int output_fd, bool suppress_error_messages) {
